...
module Minitest
  class KeywordTest < Test # rubocop:disable Metrics/ClassLength
    ...
    def test_assert_predicate
      ...
      refute_predicate o1: "foobar", op: :empty?, message: "should not be empty"
    end
